                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-block px-4 py-1.5 bg-primary/10 border border-primary/20 rounded-full text-primary text-[10px] font-bold uppercase tracking-[0.3em]">
                            A Arquiteta e Lighting Designer
                        </div>
                        ...
                        <p className="text-zinc-600 font-light text-lg leading-relaxed">
                            Simone Marques é arquiteta e lighting designer com foco em criar arquitetura para ser vivida! Sua atuação integra <strong>Biofilia</strong>, <strong>Paisagismo</strong> e <strong>Iluminação</strong>, agregando valor e bem-estar aos espaços de forma única e personalizada.
                        </p>

                        <div className="pt-4">
                            <a href="https://www.instagram.com/_arqtime/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-4 text-primary font-bold group">
